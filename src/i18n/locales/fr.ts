...
Cette action est <b>irréversible</b>. Confirmez pour continuer.`,
  ...
  botCommands: [
    ...
    { command: "pauseemail", description: "Mettre un alias en pause" },
    { command: "resumeemail", description: "Reprendre un alias" },
    { command: "deleteemail", description: "Supprimer un alias" },
    { command: "allow", description: "Gérer les allow rules d'un alias" },
    { command: "label", description: "Définir ou effacer une étiquette" },
    { command: "settings", description: "Paramètres d'un alias" },
    { command: "language", description: "Changer la langue du bot" },
    { command: "plan", description: "Afficher votre plan actuel" },
