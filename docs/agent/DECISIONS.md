...
2026-05-24 · memory system v2 adopted — lean AGENTS.md (~110 lines) + on-demand docs/agent/PROTOCOL.md + scripts (drift-check/latest-session/validate-memory) + JOURNAL.md; DECISIONS.md kept as email-to-telegram fork delta from upstream; .codex/notes.md replaces gitignored .codex empty file; `Code baseline SHA` field dropped from STATE.md · sessions/2026-05-24-152046-claude-memory-system-v2-migration.md
```
